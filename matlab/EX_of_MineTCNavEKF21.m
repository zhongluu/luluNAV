...
% load("EXNAVDATA_1031_0123.mat");
% load("EXNAVDATA_1031_0123_SPP.mat");
...
% trj.avp0=[deg2rad([0.800167051451400,-1.702403269817000,15]),0,0,0, tmpposL,posL(1,3)]; % for 0123
...
function [ins, P] = seqMEKFCorrectionTC2(ins, P, R, GNSS)
